...
const AddProduct = () => {
  ...
  return (
    <div className="bg-[#fff2f2] pt-6">
      <div className="lg:w-6/12 md:w-8/12 lg:px-10 md:px-10 w-10/12 p-3 rounded-md bg-green-200 m-auto ">
        ...
        <form onSubmit={handleAddProduct} className="">
          <div className="grid gap-5 grid-cols-2">
            <div className="">
              ...
              <input
                ...
                name="name"
                placeholder="Name"
                className="p-2 border-red-600 border w-full rounded-md"
              />
            </div>
            <div className="">
              <label className="label">
              ...
              <input
                ...
                className="p-2 border-red-600 w-full border rounded-md"
              />
          ...
          <div className="flex justify-center mt-6">
            <button className="py-2 px-5 text-lg text-white hover:bg-green-400 bg-green-600   mb-3  border font-bold">
              Add Product
            </button>
          </div>
        </form>
