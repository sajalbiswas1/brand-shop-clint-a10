                    ...
                    <div className="w-10/12 m-auto pt-12">
                        <div className="md:w-8/12 m-auto lg:grid grid-cols-2 ">
                            ...
                            <div className="h-full border flex flex-col">
                                ...
                                <p className="border flex-grow px-2 border-t-green-500 border-x-green-500 border-b-green-500 flex items-center gap-1"><span className="font-bold">Rating : </span><StarRatings rating={parseInt(myCard.rating)} starRatedColor="orange" starDimension="20px" starSpacing="1px"></StarRatings></p>
